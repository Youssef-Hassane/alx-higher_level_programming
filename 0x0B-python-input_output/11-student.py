...
class Student:
    def __init__(self, first_name, last_name, age):
        """Initialize a new Student with given first name, last name, and age."""
    ...
    def to_json(self, attributes=None):
        ...
        If attributes is a list of strings, only the specified attributes will be included.
    ...
    def reload_from_json(self, update_data):
        """
        Update the Student instance's attributes with the values from the given dictionary.
